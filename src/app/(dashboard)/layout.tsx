...
import { LayoutDashboard, Package, Tag, User, BarChart3, Receipt, FileText, History } from 'lucide-react';
      ...
      <div className="flex h-screen bg-[#f8fafc]">
        ...
        <aside className="w-64 bg-[#1a1a1a] text-white flex flex-col shrink-0 italic z-[100]">
          ...
          <nav className="flex-1 p-4 space-y-2 mt-4 font-bold text-sm">
            ...
            {/* Orders - Të gjithë */}
            <Link href="/orders" className={`flex items-center gap-4 px-4 py-3 rounded-xl ${pathname === '/orders' ? 'bg-red-600 text-white' : 'text-slate-400 hover:bg-white/5'}`}>
